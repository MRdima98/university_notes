...
\vspace{5mm}
\\ L'operatore always è vero ora e in ogni momento futuro. Esempio: lotter-win $\Rightarrow$ \square{0.3} rich. Semantica: $\pi \models \square{0.3} \; \phi \Longleftrightarrow$ for all i $\geq$ 1 we have $\pi^i \models \phi$.
\vspace{5mm}
